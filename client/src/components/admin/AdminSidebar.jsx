    ...
    return (
        <>
            <div className="side-panel flex-1 p-4 bg-card rounded-2xl border border-border h-fit">
                <Link to={'/admin'} className="logo block font-extrabold cursor-pointer mb-5">store<span className="text-accent">lo</span> <span className="text-[10px] font-mono text-accent">ADMIN</span></Link>
